...
const String SERVER_URL_ORDERS = SERVER_URL + "api/orders/getAll";
...
const String SERVER_URL_WEBCAM = SERVER_URL + "webcam/stream";
const String SERVER_URL_NOZZLE_SET = SERVER_URL + "api/printer/tool/";
